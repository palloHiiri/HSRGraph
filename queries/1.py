"""
Какие персонажи эффективны против босса Phantylia the Undying?
Возвращает персонажей, у которых элемент совпадает с уязвимостьюю босса, а также рекомендуемые световые конусы.
"""
